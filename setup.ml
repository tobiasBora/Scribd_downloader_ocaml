...
(* OASIS_START *)
(* DO NOT EDIT (digest: b15651f3e5e85f79dda77865d77a3204) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          sections =
            [
               ...
               Executable
                 ({
                     cs_name = "scribd_downloader_console";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "scribd_downloader";
                   ...
                   {exec_custom = false; exec_main_is = "main_console.ml"});
               Executable
                 ({
                     cs_name = "scribd_downloader_gui";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "main_gui.ml"})
            ];
          plugins =
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "\235?NY\148\b\142a\228\154\016'\218\240{h";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
